...
El contenido incluye nombre de empresa, usuarios (incluidos hashes de contraseña), perfil, fuentes, importaciones, ejecuciones ETL, registros procesados, alertas y consultas externas, con sus relaciones y fechas. Los metadatos de respaldos y eventos de restauración no se reemplazan. El archivo tiene límite de 100 MiB y SHA-256 para detectar alteraciones; no se guardan credenciales en la API. El directorio está ignorado por Git y debe ser privado en el despliegue.
