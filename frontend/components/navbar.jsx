    ...
    <>
      ...
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-2">
          <button type="button" onClick={() => setIsAuthOpen(true)} className="hidden rounded-lg px-3 py-2 text-sm font-medium text-[#64748B] transition-colors hover:text-[#1E293B] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue dark:text-[#94A3B8] dark:hover:text-[#F8FAFC] dark:focus-visible:ring-brand sm:inline-flex">
            Iniciar sesión
          </button>
          <a
            href="#cta"
